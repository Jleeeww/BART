...
export function Sidebar({ collapsed, onToggle }: SidebarProps) {
  ...
  return (
    ...
    >
        ...
        {navItems.map((item) => {
          ...
          if (locked) {
            return (
              <div
                key={item.route}
                className="flex items-center gap-3 py-2.5 mx-2 rounded-md cursor-not-allowed"
                style={{
          ...
          return (
            <Link key={item.route} href={item.route}>
              <div
                className={`flex items-center gap-3 py-2.5 mx-2 rounded-md transition-all duration-150 cursor-pointer ${
                  active
                    ? "text-[#38BDF8]"
                ...
                style={{
                  ...(active
                    ...
                    : {}),
                  paddingLeft: collapsed ? 0 : active ? 14 : 16,
                  justifyContent: collapsed ? "center" : "flex-start",
                }}
                title={collapsed ? item.label : undefined}
              >
      ...
      <button
        onClick={onToggle}
        className="flex items-center justify-center py-3 transition-colors hover:bg-[#ffffff06] cursor-pointer"
        style={{
